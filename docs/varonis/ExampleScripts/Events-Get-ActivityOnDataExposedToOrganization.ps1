...
<#
.SYNOPSIS
Queries Varonis API for activity events on data exposed to the whole organization.

.DESCRIPTION
This script searches for events involving data that is exposed to the entire organization
within a specified date range. Optionally filters by specific data source IDs.
...
.EXAMPLE
.\Events-Get-ActivityOnDataExposedToOrganization.ps1 -daysAgo 7
.\Events-Get-ActivityOnDataExposedToOrganization.ps1 -daysAgo 14 -dataSourceIds "1,5,10"
#>
...
# Constants
$GRAPHQL_QUERY_FILENAME = "Events - Activity on data exposed to the whole organization.gql"
$OUTPUT_FILENAME = "Events-ActivityOnDataExposedToOrganization.json"
$QUERY_DESCRIPTION = "Activity on Data Exposed to Organization"
