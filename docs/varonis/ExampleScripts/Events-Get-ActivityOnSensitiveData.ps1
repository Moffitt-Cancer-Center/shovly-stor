...
<#
.SYNOPSIS
Queries Varonis API for activity events on sensitive data.

.DESCRIPTION
This script searches for events involving sensitive data within a specified date range.
...
.EXAMPLE
.\Events-Get-ActivityOnSensitiveData.ps1 -daysAgo 7
.\Events-Get-ActivityOnSensitiveData.ps1 -daysAgo 14 -dataSourceIds "1,5,10"
#>
...
# Constants
$GRAPHQL_QUERY_FILENAME = "Events - Activity on sensitive data.gql"
$OUTPUT_FILENAME = "Events-ActivityOnSensitiveData.json"
$QUERY_DESCRIPTION = "Activity on Sensitive Data"
