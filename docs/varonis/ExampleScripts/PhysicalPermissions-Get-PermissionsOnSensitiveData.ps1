...
<#
.SYNOPSIS
Queries Varonis API for permissions on sensitive data.

.DESCRIPTION
This script searches for file system and collaboration link permissions granted on data
classified as sensitive, helping identify potential overexposure of sensitive information.
...
.\PhysicalPermissions-Get-PermissionsOnSensitiveData.ps1 -dataSourceIds "1,5,10"
#>
...
# Constants
$GRAPHQL_QUERY_FILENAME = "PhysicalPermissions - Permissions on Sensitive Data.gql"
$OUTPUT_FILENAME = "PhysicalPermissions-PermissionsOnSensitiveData.json"
$QUERY_DESCRIPTION = "Permissions on Sensitive Data"
