...
<#
.SYNOPSIS
Queries Varonis API for stale sensitive data.

.DESCRIPTION
This script searches for sensitive data that has become stale (not accessed recently),
helping organizations identify and potentially archive or remove unused sensitive
data to reduce security risk.
...
.\Resources-Get-StaleSensitiveData.ps1 -dataSourceIds "1,5,10"
#>
...
# Constants
$GRAPHQL_QUERY_FILENAME = "Resources - Stale Sensitive Data.gql"
$OUTPUT_FILENAME = "Resources-StaleSensitiveData.json"
$QUERY_DESCRIPTION = "Stale Sensitive Data"
