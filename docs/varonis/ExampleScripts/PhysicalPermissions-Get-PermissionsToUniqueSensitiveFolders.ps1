...
<#
.SYNOPSIS
Queries Varonis API for permissions to unique sensitive folders.

.DESCRIPTION
This script searches for file system and collaboration link permissions granted on folders
that are both sensitive and unique, helping identify high-risk permission exposures on 
...
.\PhysicalPermissions-Get-PermissionsToUniqueSensitiveFolders.ps1 -dataSourceIds "1,5,10"
#>
...
# Constants
$GRAPHQL_QUERY_FILENAME = "PhysicalPermissions - Permissions to Unique Sensitive Folders.gql"
$OUTPUT_FILENAME = "PhysicalPermissions-PermissionsToUniqueSensitiveFolders.json"
$QUERY_DESCRIPTION = "Permissions to Unique Sensitive Folders"
