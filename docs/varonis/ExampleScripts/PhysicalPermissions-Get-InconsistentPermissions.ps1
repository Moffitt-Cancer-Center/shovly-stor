...
<#
.SYNOPSIS
Queries Varonis API for inconsistent (broken) permissions.

.DESCRIPTION
This script searches for permission entries that are inconsistent or broken,
indicating potential security misconfigurations that need attention.
...
.\PhysicalPermissions-Get-InconsistentPermissions.ps1 -dataSourceIds "1,5,10"
#>
...
# Constants
$GRAPHQL_QUERY_FILENAME = "PhysicalPermissions - Inconsistent (Broken) Permissions.gql"
$OUTPUT_FILENAME = "PhysicalPermissions-InconsistentPermissions.json"
$QUERY_DESCRIPTION = "Inconsistent (Broken) Permissions"
