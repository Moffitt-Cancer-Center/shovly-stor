...
<#
.SYNOPSIS
Queries Varonis API for classified objects/resources.

.DESCRIPTION
This script searches for resources that contain classified data, helping organizations
understand their data classification landscape and ensure proper protection of 
...
# Constants
$GRAPHQL_QUERY_FILENAME = "Resources - Classified Objects.gql"
$OUTPUT_FILENAME = "Resources-ClassifiedObjects.json"
$QUERY_DESCRIPTION = "Classified Objects"
